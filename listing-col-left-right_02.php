		...
		<div id="pageContent">
			<div class="container">
				...
				<div class="row">
					...
					<!-- /left column --> 
					<!-- center column -->
					<aside class="col-md-8 col-lg-6 col-xl-8" id="centerColumn">
						<!-- title -->
						<div class="title-box">
						...
						<div class="product-listing row">
							<div class="col-xs-6 col-sm-4 col-md-6 col-lg-6 col-xl-3">
								<!-- product -->
					...
					<aside class="col-md-4 col-lg-3 col-xl-2 hidden-xs hidden-sm hidden-md" id="rightColumn">					
							...
							<div class="collapse-block__content">
								...
								<form id="pollForm1" action="#">
									<ul class="filter-list">
										<li>
											<label class="radio">
											<input id="radio11" type="radio" name="radios" checked>
											<span class="outer"><span class="inner"></span></span>Green</label>
										</li>
										<li>
											<label class="radio">
											<input id="radio21" type="radio" name="radios">
											<span class="outer"><span class="inner"></span></span>Red</label>
										</li>
										<li>
											<label class="radio">
											<input id="radio31" type="radio" name="radios">
											<span class="outer"><span class="inner"></span></span>Black</label>
										</li>
										<li>
											<label class="radio">
											<input id="radio41" type="radio" name="radios">
											<span class="outer"><span class="inner"></span></span>Magenta</label>
										</li>
									</ul>
									<button type="submit" class="btn btn--ys btn--md btn--light">Vote</button>
						...
						<div class="collapse-block open">
							<h4 class="collapse-block__title">FEATURED</h4>
							<div class="collapse-block__content">
								<div class="vertical-carousel vertical-carousel-1 offset-top-10">
									<div class="vertical-carousel__item">
										<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="images/product/product-80x100-1.jpg" alt=""></a>
										</div>
										<div class="vertical-carousel__item__title">
