	...
	<body class="index">
		...
		<div id="pageContent">
			...
			<div class="content offset-top-0">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 col-md-8 col-md-offset-2 col-lg-4 col-lg-offset-0">
							<div class="lookbook-layout2">
								<div class="lookbook__image"><img src="images/custom/lookbook-img-03.jpg" class="img-responsive1" alt=""/></div>
								<!-- item -->
								<div class="hint" style="top: 2.4%; left: 3.7%; width:53.7%;">
									<img src="images/custom/lookbook-img-03_01.png" class="img-responsive1" alt=""/>
									<!--  -->
					                  		...
					                  		<span class="hover-tool__text"> 
					                  			<a  href="listing.html">
					                  				<span class="hint-title">Mauris lacinia  <br>lectus </span>				                  				
						           					<span class="hint-price">$26.00</span>						           					
					                  			</a>
					                  			<a href="#"><span class="icon icon-shopping_basket"></span></a>
					                  		</span> 
					                  	</div>
					                </div>
									<!-- / -->
								...
								<!-- /item -->
								<!-- item -->
								<div class="hint" style="top: 52.2%; left: 3.7%; width:28%;">
									<img src="images/custom/lookbook-img-03_02.png" class="img-responsive1" alt=""/>
									<!--  -->
									<div class="tool tool--right">							               			                	
					                	<div class="hover-tool">
					                  		<div class="hover-tool__tip"></div>
					                  		<span class="hover-tool__text"> 
					                  			<a  href="listing.html">
					                  				<span class="hint-title">Mauris lacinia  <br>lectus </span>					                  				
						           					<span class="hint-price">$4.00</span>						           					
					                  			</a>
					                  			<a href="#"><span class="icon icon-shopping_basket"></span></a>
					                  		</span> 
					                  	</div>
								...
								<!-- /item -->
								<!-- item -->
								<div class="hint" style="top: 68.3%; left: 3.7%; width:28%;">
									<img src="images/custom/lookbook-img-03_03.png" class="img-responsive1" alt=""/>
									<!--  -->
									<div class="tool tool--right">							               			                	
					                	<div class="hover-tool">
					                  		<div class="hover-tool__tip"></div>
					                  		<span class="hover-tool__text"> 
					                  			<a  href="listing.html">
					                  				<span class="hint-title">Mauris lacinia  <br>lectus </span>					                  				
						           					<span class="hint-price">$6.00</span>						           					
					                  			</a>
					                  			<a href="#"><span class="icon icon-shopping_basket"></span></a>
					                  		</span> 
					                  	</div>
								...
								<!-- /item -->
								<!-- item -->
								<div class="hint" style="top: 83.3%; left: 3.7%; width:48%;">
									<img src="images/custom/lookbook-img-03_04.png" class="img-responsive1" alt=""/>
									<!--  -->
									<div class="tool tool--right">							               			                	
					                	<div class="hover-tool">
					                  		<div class="hover-tool__tip"></div>
					                  		<span class="hover-tool__text"> 
					                  			<a  href="listing.html">
					                  				<span class="hint-title">Mauris lacinia  <br>lectus </span>					                  				
						           					<span class="hint-price">$12.00</span>						           					
					                  			</a>
					                  			<a href="#"><span class="icon icon-shopping_basket"></span></a>
					                  		</span> 
					                  	</div>
								...
								<!-- /item -->
								<!-- item -->
								<div class="hint" style="top: 3.3%; right: 4.3%; width:37.5%;">
									<img src="images/custom/lookbook-img-03_05.png" class="img-responsive1" alt=""/>
									<!--  -->
									<div class="tool tool--left">							               			                	
					                	<div class="hover-tool">
					                  		...
					                  		<span class="hover-tool__text"> 
					                  			<a  href="listing.html">
					                  				<span class="hint-title">Mauris lacinia  <br>lectus </span>					                  				
						           					<span class="hint-price">$5.00</span>						           					
					                  			</a>
					                  			<a href="#"><span class="icon icon-shopping_basket"></span></a>
					                  		</span> 
					                  	</div>
								...
								<!-- /item -->
								<!-- item -->
								<div class="hint" style="top: 22.3%; right: 4.3%; width:37.5%;">
									<img src="images/custom/lookbook-img-03_06.png" class="img-responsive1" alt=""/>
									<!--  -->
									<div class="tool tool--left">							               			                	
					                	<div class="hover-tool">
					                  		<div class="hover-tool__tip"></div>
					                  		<span class="hover-tool__text"> 
					                  			<a  href="listing.html">
					                  				<span class="hint-title">Mauris lacinia  <br>lectus </span>					                  				
						           					<span class="hint-price">$7.00</span>						           					
					                  			</a>
					                  			<a href="#"><span class="icon icon-shopping_basket"></span></a>
					                  		</span> 
					                  	</div>
								...
								<!-- /item -->
								<!-- item -->
								<div class="hint" style="top: 32.2%; right: 4.3%; width:37.5%;">
									<img src="images/custom/lookbook-img-03_07.png" class="img-responsive1" alt=""/>
									<!--  -->
									<div class="tool tool--left">							               			                	
					                	<div class="hover-tool">
					                  		<div class="hover-tool__tip"></div>
					                  		<span class="hover-tool__text"> 
					                  			<a  href="listing.html">
					                  				<span class="hint-title">Mauris lacinia  <br>lectus </span>					                  				
						           					<span class="hint-price">$10.00</span>						           					
					                  			</a>
					                  			<a href="#"><span class="icon icon-shopping_basket"></span></a>
					                  		</span> 
					                  	</div>
								...
								<!-- /item -->
								<!-- item -->
								<div class="hint" style="top: 36.6%; left: 25.2%; width:55%;">
									<img src="images/custom/lookbook-img-03_08.png" class="img-responsive1" alt=""/>
									<!--  -->
									<div class="tool tool--center">							               			                	
					                	<div class="hover-tool">
					                  		<div class="hover-tool__tip"></div>
					                  		<span class="hover-tool__text"> 
					                  			<a  href="listing.html">
						...
						<div class="divider divider--lg visible-sm visible-xs visible-md"></div>
						<div class="col-sm-12 col-md-8 col-md-offset-2 col-lg-4 col-lg-offset-0">
							<div class="lookbook-layout1">
						        <div class="lookbook__image">
						        	<img src="images/custom/lookbook-img-02.jpg" class="img-responsive" alt=""/>
						...
						<div class="col-sm-12 col-md-8 col-md-offset-2 col-lg-4 col-lg-offset-0">
							<div class="lookbook">
						          <div class="lookbook__image"><img src="images/custom/lookbook-img-01.jpg" class="img-responsive" alt=""/>
						          	<!-- item -->
