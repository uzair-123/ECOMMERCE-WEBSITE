	   ...
	   <!-- mobile menu -->
		...
		<div class="breadcrumbs">
			<div class="container">
				<ol class="breadcrumb breadcrumb--ys pull-left">
					...
					<li class="active">Empty Category</li>
				</ol>
			</div>
		</div>
		<!-- /breadcrumbs --> 
		...
		<div id="pageContent">
			<div class="container">				
				<!-- title -->
				<div class="title-box">
					<h1 class="text-center text-uppercase title-under">EMPTY СATEGORY</h1>
				</div>
				<!-- /title -->		
				<div class="text-center"> 
		          <img src="images/empty-category-icon.png" alt="empty category icon" class="img-responsive-inline" />
		          <div class="divider divider--lg"></div>
		          <h4 class="color">There are no products matching the selection.</h4>		          
		        </div>					
			</div>
		</div>
		<!-- End CONTENT section --> 
