										...
										<div class="product__inside__image">
											...
											<div class="product__inside__carousel slide" data-ride="carousel">
												<div class="carousel-inner" role="listbox">
													<div class="item active"> <a href="product.html"><img src="images/custom/layout12/products/product-03.jpg" alt=""></a> </div>
													<div class="item"> <a href="product.html"><img src="images/custom/layout12/products/product-03.jpg" alt=""></a> </div>
													<div class="item"> <a href="product.html"><img src="images/custom/layout12/products/product-03.jpg" alt=""></a> </div>
												</div>
												<!-- Controls --> 
							...
							<div class="col-xs-6 col-sm-4 col-md-6 col-lg-4 col-xl-one-fifth">
								...
								<div class="product product--zoom">
									<div class="product__inside">
										<!-- product image -->
										<div class="product__inside__image">
											<a href="product.html"> <img src="images/custom/layout12/products/product-01.jpg" alt=""> </a> 
											<!-- quick-view --> 
											<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
											<!-- /quick-view --> 
										</div>
							...
							<div class="col-xs-6 col-sm-4 col-md-6 col-lg-4 col-xl-one-fifth">
								...
								<div class="product product--zoom">
									<div class="product__inside">
										<!-- product image -->
										<div class="product__inside__image">
											<a href="product.html"> <img src="images/custom/layout12/products/product-02.jpg" alt=""> </a> 
											<!-- quick-view --> 
											<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
											<!-- /quick-view --> 
										</div>
							...
							<div class="col-xs-6 col-sm-4 col-md-6 col-lg-4 col-xl-one-fifth">
								...
								<div class="product product--zoom">
									<div class="product__inside">
										<!-- product image -->
										<div class="product__inside__image">
											<a href="product.html"> <img src="images/custom/layout12/products/product-04.jpg" alt=""> </a> 
											<!-- quick-view --> 
											<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
											<!-- /quick-view --> 
										</div>
							...
							<div class="col-xs-6 col-sm-4 col-md-6 col-lg-4 col-xl-one-fifth">
								...
								<div class="product product--zoom">
									<div class="product__inside">
										<!-- product image -->
										<div class="product__inside__image">
											<a href="product.html"> <img src="images/custom/layout12/products/product-05.jpg" alt=""> </a> 
											<!-- quick-view --> 
											<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
											<!-- /quick-view --> 
										</div>
