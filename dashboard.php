			...
			<div class="container">				
				...
				<div class="row">
					...
					<div class="col-md-9">
						<!-- title -->
						<div class="title-box">
							<h1 class="text-left text-uppercase title-under">My Dashboard</h1>
						</div>
						<!-- /title -->
						<p>
							<strong class="color-dark">Hello, igor igor!</strong>
						</p>
						...
						<hr>
						<h3 class="color font22">ACCOUNT INFORMATION</h3>
						<div class="divider divider--lg "></div>
						<div class="row">
							<div class="col-md-12 col-lg-5">
								<a class="btn btn--ys btn--light pull-right" href="#"><span class="icon icon-create"></span> Edit</a>
								<h4>CONTACT INFORMATION</h4>
								<p>igor igor</p>
								<p>igor@gmail.com</p>
								<a class="color text-uppercase font-middle font13" href="#">Change Password</a>												
							</div>
