...
<html lang="en">
	...
	<body>
	  ...
	  <!-- mobile menu -->
					...
					<div class="row">
						...
						<div class="hidden-xs clearfix">
							<div class="bigGallery box-baners">
								<div class="col-md-3">
									<img src="images/custom/product_big_img_01.jpg" zoom-image="images/custom/product_big_img_01.jpg" class="img-responsive product-zoom1 " alt="">
								</div>
								<div class="col-md-3">
									<img src="images/custom/product_big_img_02.jpg" zoom-image="images/custom/product_big_img_02.jpg" class="img-responsive product-zoom1" alt="">
								</div>
								<div class="col-md-3">
									<img src="images/custom/product_big_img_03.jpg" zoom-image="images/custom/product_big_img_03.jpg" class="img-responsive product-zoom1" alt="">
								</div>							
								<div class="col-md-3">
									<img src="images/custom/product_big_img_01.jpg" zoom-image="images/custom/product_big_img_01.jpg" class="img-responsive product-zoom1" alt="">
								</div>
						...
						<div class="visible-xs">
							...
							<ul id="mobileGallery">
								<li><a href="#" data-image="images/product/product-big-1.jpg"><img src="images/product/product-small-1.jpg" alt="" /></a></li>
								<li><a href="#" data-image="images/product/product-big-2.jpg"><img src="images/product/product-small-2.jpg" alt="" /></a></li>
								<li><a href="#" data-image="images/product/product-big-3.jpg"><img src="images/product/product-small-3.jpg" alt="" /></a></li>
								<li><a href="#" data-image="images/product/product-big-4.jpg"><img src="images/product/product-small-4.jpg" alt="" /></a></li>
								<li><a href="#" data-image="images/product/product-big-5.jpg"><img src="images/product/product-small-5.jpg" alt="" /></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="product-info product-info-big text-center product-info-outer">						
						...
						<div class="wrapper">
							...
							<div class="product-info__sku color-dark">SKU: <strong class="text-color">mtk012c</strong></div>
							<div class="product-info__availability color-dark">Availability:   <strong class="color">In Stock</strong></div>
						</div>
						<div class="product-info__title">
							<h2>Lorem ipsum dolor sit ctetur</h2>
						</div>						
						<div class="price-box product-info__price"><span class="price-box__new">$26.00</span></div>
						<div class="wrapper text-center">
							<span class="option-label">SIZE:</span> <span class="required">*</span>
				...
				<div class="tab-content tab-content--ys-fullwidth">
					<div role="tabpanel" class="tab-pane active" id="Tab1">
						<div class="content offset-top-0  fullwidth container-no-col-indent">
							<div class="row">
								<div class="col-sm-12 text-center">
									<img src="images/custom/product_big_img_04.jpg" class="img-responsive1" alt="">
								</div>
							</div>
						</div>
						...
						<div class="container-fluid container-fluid-large container-no-col-indent">
							<div class="row">
								<div class="pull-left col-xs-12 col-sm-12 col-md-6">
									<img src="images/custom/product_big_img_05.jpg" class="img-responsive" alt="">
								</div>
						...
						<div class="container-fluid  container-fluid-large  container-no-col-indent">
							<div class="row">
								<div class="pull-right col-xs-12 col-sm-12 col-md-6">
									<img src="images/custom/product_big_img_06.jpg" class="img-responsive" alt="">
								</div>
								<div class="pull-left col-xs-12 col-sm-12 col-md-6">
									<div class="product-data-big">
										<h5>About</h5>
						...
						<div class="container-fluid  container-fluid-large  container-no-col-indent">
							<div class="row">
								<div class="col-xs-6">
									<img src="images/custom/product_big_img_07.jpg" class="img-responsive" alt="">
								</div>
								<div class="col-xs-6">
									<img src="images/custom/product_big_img_08.jpg" class="img-responsive" alt="">
								</div>
							</div>
						</div>
					</div>
		...
		<script src="js/js-product-big.js"></script>		
	</body>
</html>