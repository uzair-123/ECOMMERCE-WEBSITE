	...
	<body>
		...
		<div class="breadcrumbs">
			<div class="container">
				<ol class="breadcrumb breadcrumb--ys pull-left">
					...
					<li class="active">GALLERY - LAYOUT 2</li>
				</ol>
			</div>
		</div>
		<!-- /breadcrumbs --> 
		...
		<div id="pageContent">
			<div class="container-fill">
				<h1 class="text-center text-uppercase title-under">Gallery - Layout 2</h1>												
				<!-- gallery -->
				<div id="page-wrap" class="gallery">	
			        ...
			        <div id="filter-content" class="gallery-content row">         
				        <div class="filter-content-item all people col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-01.jpg" class="all people" alt="" />
				        			...
				        			<div class="block-table">
				        				<div class="block-table-cell">
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-01.jpg" class="zomm-gallery"  title="Title"></a>
				        ...
				        <div class="filter-content-item all nature col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-02.jpg" class="all people" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->						        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-02.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div> 
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all people col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-03.jpg" class="all people" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->						        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-03.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div> 
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all people col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-04.jpg" class="all people" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->						        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-04.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div> 
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all objects col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-05.jpg" class="all objects" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->						        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-05.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div> 
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all nature col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-06.jpg" class="all people" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->						        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-06.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div> 
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all people col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-07.jpg" class="all people" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->						        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-07.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div> 
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all objects col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-08.jpg" class="all people" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->						        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-08.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div> 
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all people col-sm-6  col-md-4 col-lg-4">
				        	<figure>
				        		<img src="images/gallery/gallery-middle/gallery-middle-img-09.jpg" class="all people" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->						        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-middle/gallery-middle-img-09.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div> 
				        				</div>
				        			</div>
