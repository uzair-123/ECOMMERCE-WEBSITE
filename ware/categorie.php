...
$active = $_POST['active'] ;
   ...
   if(empty($errors)){
      $sql  = "INSERT INTO categories (name,parent_id,active)";
      $sql .= " VALUES ('$cat_name','$cat','$active')";
      if($db->query($sql)){
          ...
          <form method="post" action="categorie.php">
            <div class="form-group">
                <input type="text" class="form-control" name="categorie-name" placeholder="Categorie Name">
                 ...
                 <div class="form-group">
                <input type="text" class="form-control" name="categorie-id" placeholder="Parent Category Id">
            </div>


               <div class="form-group">
                <input type="text" class="form-control" name="active" placeholder="Status">
            </div>
