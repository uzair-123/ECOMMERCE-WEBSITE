			...
			<div class="container">				
				...
				<div class="row">
					<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3  col-sm-center">
						<img class="img-responsive1" src="images/custom/img_icon-04.png" alt=""/>
					...
					<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 col-sm-center">
						<img class="img-responsive1" src="images/custom/img_icon-05.png" alt=""/>
						<div class="divider divider--lg"></div>
					...
					<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 col-sm-center">						
						<img class="img-responsive1" src="images/custom/img_icon-06.png" alt=""/>
						<div class="divider divider--lg"></div>						
					...
					<div class="divider divider--lg visible-sm visible-xs"></div>
					<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 col-sm-center">						
						<img class="img-responsive1" src="images/custom/img_icon-07.png" alt=""/>
						<div class="divider divider--lg"></div>						
