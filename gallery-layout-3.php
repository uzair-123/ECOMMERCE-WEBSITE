	...
	<body>
		...
		<div class="breadcrumbs">
			<div class="container">
				<ol class="breadcrumb breadcrumb--ys pull-left">
					...
					<li class="active">GALLERY - LAYOUT 3</li>
				</ol>
			</div>
		</div>
		<!-- /breadcrumbs --> 
		...
		<div id="pageContent">
			<div class="container-fill">
				<h1 class="text-center text-uppercase title-under">Gallery - Layout 3</h1>												
				<!-- gallery -->
				<div id="page-wrap" class="gallery">	
			        ...
			        <div id="filter-content" class="gallery-content row gallery-layout-3">         
				        <div class="filter-content-item all people col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-01.jpg" alt="" />
				        			...
				        			<div class="block-table">
				        				<div class="block-table-cell">
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-01.jpg" class="zomm-gallery"  title="Title"></a>
				        ...
				        <div class="filter-content-item all objects col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-02.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-02.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all nature col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-03.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-03.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all people col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-04.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-04.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all nature col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-05.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-05.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all people col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-06.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-06.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all people col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-07.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-07.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all objects col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-08.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-08.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all nature col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-09.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-09.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all people col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-10.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-10.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all objects col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-11.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-11.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all objects col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-12.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-12.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all people col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-13.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-13.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all nature col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-14.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-14.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all people col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-15.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-15.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
				        ...
				        <div class="filter-content-item all people col-sm-6 col-md-4  col-lg-3 col-xl-3">
				        	<figure>
				        		<img src="images/gallery/gallery-small/gallery-small-img-16.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->					        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/gallery-small/gallery-small-img-16.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div> 
