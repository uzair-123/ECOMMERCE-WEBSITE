...
<html lang="en">
	...
	<body>
		...
		<div id="pageContent">
			<div class="container">		
				<a class="btn btn--ys btn-lg text-uppercase  btn--sm hidden-xs hidden-sm btn-absolute   btn--light" href="#"><span class="icon icon-print  font20_"></span>Print This Page</a>
				<!-- title -->
				<div class="title-box">	

					<h1 class="text-center text-uppercase title-under">COMPARE PRODUCTS</h1>
				</div>
				<!-- /title -->				
				<!-- compare -->
				<div class="compare-table">
					<table class="table-bordered">
						...
						<tr>							
							...
							<!-- item 01 -->
							<td>
								<a href="#" class="link-close icon icon-close pull-right"></a>
								<div class="product">
									<!-- product image -->
									<div class="product__inside__image">
									...
									<ul class="product__inside__info__link visible-xs">
