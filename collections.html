	...
	<body>
		...
		<div id="pageContent">
			<div class="container">				
				...
				<div class="divider"></div>
				<div class="row">						
						<div class="col-xs-12 col-xs-offset-0 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0 col-lg-4">
							<a href="#" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/collections-img-07.jpg" alt=""/>
								<span class="figcaption">
									<span class="block-table">
										<span class="block-table-cell">
											<span class="banner__title size40">SWEATSHIRTS</span>
											<span class="btn btn--ys btn--xl">Shop now!</span>
										</span>
									</span>
								</span>
						...
						<div class="col-xs-12 col-xs-offset-0 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0 col-lg-4">
							<a href="#" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/collections-img-08.jpg" alt=""/>
								<span class="figcaption">
									<span class="block-table">
										<span class="block-table-cell">
											<span class="banner__title size40">t-shirts</span>
											<span class="btn btn--ys btn--xl">Shop now!</span>
										</span>
									</span>
								</span>
						...
						<div class="col-xs-12 col-xs-offset-0 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-0 col-lg-4">
							<a href="#" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/collections-img-09.jpg" alt=""/>
								<span class="figcaption">
									<span class="block-table">
										<span class="block-table-cell">
											<span class="banner__title size40">Shoes</span>
											<span class="btn btn--ys btn--xl">Shop now!</span>
										</span>
									</span>
								</span>
