	...
	<body>
		...
		<div id="pageContent">
			<div class="container">				
				<!-- title -->
				<div class="title-box">
					<h1 class="text-center text-uppercase title-under">Search results for <span class="color">'dddddd'</span></h1>
				</div>
				<!-- /title -->		
				<div class="text-center"> 
		          <img src="images/empty-search-icon.png" alt="empty search icon" class="img-responsive-inline" />
