						...
						<div class="pull-right pull-extra-left">
							<div class="dropdown select-basket">
								<a class="dropdown-toggle" data-toggle="dropdown">
									...
									<span class="icon icon-shopping_basket"></span> $258.00										
								</a>
									...
									<div class="select-basket__inner">
										...
										<table class="select-basket__table">
											...
											<tbody>
												<tr>
													<td>
														<span class="color">Labore et dolore magna</span>
													</td>
													<td>
														1
													</td>
													<td>
														<b class="color">$28.00</b>
													</td>
												</tr>																					
											</tbody>
											<tfoot>
					...
					<div class="col-md-12 col-lg-4">
						...
						<form >
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									    <label for="checkoutFormCity1">City <sup>*</sup></label>
									    <input type="text" class="form-control" id="checkoutFormCity1">
									</div>
									<div class="form-group">
									    <label for="checkoutFormZip1">Zip/Postal Code <sup>*</sup></label>
									    <input type="text" class="form-control" id="checkoutFormZip1">
									</div>
									<div class="form-group">
									    <label for="checkoutFormTelephone1">Telephone <sup>*</sup></label>
									    <input type="text" class="form-control" id="checkoutFormTelephone1">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
									...
									<div class="form-group">
									    <label for="checkoutFormCountry1">Country <sup>*</sup></label>
									    <select  id="checkoutFormCountry1" class="form-control selectpicker "  data-style="select--ys"  data-width="100%">                  
											<option>Country</option>						                    
						                </select>
									</div>
									<div class="form-group">
									    <label for="checkoutFormFax">Fax</label>
									    <select  id="checkoutFormFax" class="form-control selectpicker "  data-style="select--ys"  data-width="100%">                  
											<option>Fax</option>						                    
						                </select>
									</div>
								</div>
						...
						<!-- row-col-2 -->
							...
							<div class="row">
								...
								<div class="col-md-12 col-lg-12 col-xl-6">
									<div class="form-group">
									    <label for="checkoutFormState1">State/Province <sup>*</sup></label>
									    <select  id="checkoutFormState1" class="form-control selectpicker "  data-style="select--ys"  data-width="100%">                  
											<option>State</option>						                    
						                </select>
									</div>
									<div class="form-group">
									    <label for="checkoutFormCountry3">Country <sup>*</sup></label>
									    <select  id="checkoutFormCountry3" class="form-control selectpicker "  data-style="select--ys"  data-width="100%">                  
											<option>Country</option>						                    
						                </select>
									</div>
									<div class="form-group">
									    <label for="checkoutFormFax1">Fax</label>
									    <select  id="checkoutFormFax1" class="form-control selectpicker "  data-style="select--ys"  data-width="100%">                  
											<option>Fax</option>						                    
						                </select>
									</div>
								</div>
