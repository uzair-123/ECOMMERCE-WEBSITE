	...
	<body>
		...
		<div class="breadcrumbs">
			<div class="container">
				<ol class="breadcrumb breadcrumb--ys pull-left">
					...
					<li class="active">GALLERY - LAYOUT 5</li>
				</ol>
			</div>
		</div>
		<!-- /breadcrumbs --> 
		...
		<div id="pageContent">
			<div class="container-fill">
				<h1 class="text-center text-uppercase title-under">Gallery - Layout 5</h1>												
				<!-- gallery -->
				<div id="page-wrap" class="gallery">	
			        ...
			        <div id="filter-content" class="gallery-content row css-masonry">       
				         ...
				         <div class="filter-content-item all people col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-01.jpg" alt="" />
				        			...
				        			<div class="block-table">
				        				<div class="block-table-cell">
						        			...
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-01.jpg" class="zomm-gallery"  title="Title"></a>
				        ...
				        <div class="filter-content-item all people col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-02.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-02.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all nature col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-03.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-03.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				      	...
				      	<div class="filter-content-item all nature col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-04.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-04.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all people col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-05.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-05.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all nature col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-06.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-06.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all people col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-07.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-07.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all nature col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-08.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-08.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all objects col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-09.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-09.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all nature col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-10.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-10.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all objects col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-11.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-11.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all nature col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-12.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-12.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
				        ...
				        <div class="filter-content-item all nature col-item-4">
				        	<figure>
				        		<img src="images/gallery/different-height/gallery-img-13.jpg" alt="" />
				        		<figcaption><!-- add class .content-center in figcaption (center icons)-->				        			
				        			<div class="block-table">
				        				<div class="block-table-cell">
				        					<h6 class="title text-uppercase"><a href="#">Mauris lacinia lectus</a></h6>
						        			...
						        			<div class="divider divider--sm"></div>
						        			<div class="button-box">
						        				<a href="images/gallery/different-height/gallery-img-13.jpg" class="zomm-gallery"  title="Title"></a>
						        				<a href="#" class="link-gallery"></a>
						        			</div>
				        				</div>
				        			</div>
