	...
	<body>
		...
		<div id="pageContent">
			<div class="container">				
				<!-- title -->
				<div class="title-box">
					<h1 class="text-center text-uppercase title-under">Payment Method</h1>
				</div>
				<!-- /title -->				
				<div class="row">
					<div class="col-sm-12 col-md-4">
						<img class="img-responsive1" src="images/custom/img_icon-01.png" alt=""/>
					...
					<div class="col-sm-12 col-md-4 col-sm-center">
						<img class="img-responsive" src="images/custom/img_icon-02.png" alt=""/>
						<div class="divider divider--lg"></div>
					...
					<div class="divider divider--lg visible-sm visible-xs"></div>
					<div class="col-sm-12 col-md-4 col-sm-center">						
						<img class="img-responsive" src="images/custom/img_icon-03.png" alt=""/>
						<div class="divider divider--lg"></div>						
