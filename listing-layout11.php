			...
			<nav id="off-canvas-menu">				
				<ul class="expander-list">				
					...
					<li>
						<span class="name">
							<span class="expander">-</span>
							<a href="product-layout11.html"><span class="act-underline"><span class="act-underline">PRODUCT</span></span></a>
						</span>
						<ul class="dropdown-menu megamenu image-links" role="menu">							
					...
					<li>
						<span class="name">
							<span class="expander">-</span>
							<a href="listing.html"><span class="act-underline">Electronics<span class="badge badge--menu badge--color">SALE</span></span></a>
						</span>
									...
									<div class="col-stuck-menu">
										...
										<ul class="nav navbar-nav">
											...
											<li class="dropdown dropdown-mega-menu active">
												...
												<a href="listing-layout11.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">LISTING</span></a>
												<ul class="dropdown-menu megamenu image-links" role="menu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-one-fourth">
														<span class="image-link">
														<a href="listing-layout11.html">
														<span class="figure"><img class="img-responsive" src="images/custom/listing-img-1.png" alt=""/></span>
														<span class="figcaption text-uppercase">left column</span>
														</a>
														</span>
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="product-layout11.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">PRODUCT</span></a>
												<ul class="dropdown-menu megamenu image-links" role="menu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-one-third">
														<span class="image-link">
											...
											<li class="dropdown dropdown-mega-menu">
												<span class="dropdown-toggle extra-arrow"></span>
												<a href="listing-layout11.html" class="dropdown-toggle" data-toggle="dropdown"><span class="act-underline">Electronics<span class="badge badge--menu badge--color">SALE</span></span></a>
												<ul class="dropdown-menu megamenu" role="menu">
													<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
													<li class="col-sm-3">												
														<a href="listing-layout11.html" class="megamenu__subtitle">
															<span>Laptops</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="images/custom/layout11/mens-category-1.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing-layout11.html">MaciBooks</a></li>
															<li class="level2"><a href="listing-layout11.html">Chromebooks <span class="badge badge--menu badge--color">SALE</span></a></li>
															<li class="level2"><a href="listing-layout11.html">Gaming Laptops</a></li>
															<li class="level2"><a href="listing-layout11.html">Business Laptops</a></li>
														</ul>
													</li>
													<li class="col-sm-3">
														<a href="listing-layout11.html" class="megamenu__subtitle">
															<span>Phones</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="images/custom/layout11/mens-category-2.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing-layout11.html">Cellphones</a></li>
															<li class="level2"><a href="listing-layout11.html">Cell Phones with Plans</a></li>
															<li class="level2"><a href="listing-layout11.html">No-Contract Phones</a></li>
															<li class="level2"><a href="listing-layout11.html">Accesories</a></li>
														</ul>
													</li>
													<li class="col-sm-3">
														<a href="#" class="megamenu__subtitle">
															<span>Tablets</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="images/custom/layout11/mens-category-3.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing-layout11.html">2-in-1s</a></li>
															<li class="level2"><a href="listing-layout11.html">Ipadi & Tablets</a></li>
															<li class="level2"><a href="listing-layout11.html">Kids Tablets</a></li>
														</ul>
													</li>
													<li class="col-sm-3">
														<a href="#" class="megamenu__subtitle">
															<span>Smartwatches</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="images/custom/layout11/mens-category-4.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing-layout11.html">Smartwatch</a></li>
															<li class="level2"><a href="listing-layout11.html">Watch</a></li>
															<li class="level2"><a href="listing-layout11.html">Watch Sport</a></li>
														</ul>
													</li>
							          ...
							          <ul class="dropdown-menu " role="menu">
							            ...
							            <li class='li-col languages languages--flag'>									 
							              ...
							              <ul>
							                ...
							                <li class="languages__item">
							                	<a href="#">
							                		<span class="languages__item__flag flag"><img src="images/flags/es.png" alt=""/></span>
							                		<span class="languages__item__label">Spanish</span>
							                	</a>
							                </li>
							                <li class="languages__item">
							                	<a href="#">
							                		<span class="languages__item__flag flag"><img src="images/flags/ru.png" alt=""/></span>
							...
							<div class="col-xs-6 col-sm-4 col-md-6 col-lg-4 col-xl-one-fifth">
								...
								<div class="product product--zoom">
									<div class="product__inside">
										<!-- product image -->
										<div class="product__inside__image">
											<a href="product.html"> <img src="images/custom/layout11/products/product-02.jpg" alt=""> </a> 
											<!-- quick-view --> 
											<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
											<!-- /quick-view --> 
										</div>
							...
							<div class="col-xs-6 col-sm-4 col-md-6 col-lg-4 col-xl-one-fifth">
								...
								<div class="product product--zoom">
									<div class="product__inside">
										<!-- product image -->
										<div class="product__inside__image">
											<a href="product.html"> <img src="images/custom/layout11/products/product-04.jpg" alt=""> </a> 
											<!-- quick-view --> 
											<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
											<!-- /quick-view --> 
										</div>
							...
							<div class="col-xs-6 col-sm-4 col-md-6 col-lg-4 col-xl-one-fifth">
								...
								<div class="product product--zoom">
									<div class="product__inside">
										<!-- product image -->
										<div class="product__inside__image">
											<a href="product.html"> <img src="images/custom/layout11/products/product-05.jpg" alt=""> </a> 
											<!-- quick-view --> 
											<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
											<!-- /quick-view --> 
										</div>
